...
if (!m.isGroup) return reply(lang.groupOnly())
	    ...
	    case 'toimage': case 'toimg': {
            ...
            var but = [
				{
					"urlButton": {
						"displayText": "Jangan Spam Ya Tod🗿",
						"url": `${myweb}`
						}
					}
				]
          ...
          {
            "urlButton": {
              "displayText": "YouTube Zaky👨‍💻",
              "url": `${youtube}`
            }
          },
          {
            "urlButton": {
              "displayText": "Api Work Zakybot💻",              
              "url": `${myweb}`
...
"id": 'rules'
          ...
          {
            "quickReplyButton": {
              "displayText": "🗿Yang Kepo Siapa Zaky🗿",
"id": 'owner'
            }
          },
{
            "quickReplyButton": {
              "displayText": "👉Click Sini Yah👈",
"id": 'command'
            }
          }
        ]
...
break
            ...
            case 'tagall': case 'infoall':
                if (!m.isGroup) return reply(lang.groupOnly())
                if (!(isGroupAdmins || isGroupOwner )) return reply(lang.adminOnly())
                let tekss = `══✪〘 *😠Jangan Marah Kalo Di Tag Ya😠* 〙✪══\n\n➲ *Message : ${q ? q : 'Nothing'}*\n\n`
		      	for (let mem of participants) {
		            tekss += `(☞ ಠ_ಠ)☞ @${mem.id.split('@')[0]}\n`
				}
                tekss += `\n⋙ *${botname}* ⋘`
...
break
            ...
            break
				case 'menu':{
					if(typemenu == 'templateLocation'){
						await alpha.send5ButLoc(from, lang.menunya(salam, pushname, botname) , `© ${ownername}`,pp_bot, [{"urlButton": {"displayText": "YouTube Zaky👨‍💻","url": `${youtube}`}},{"urlButton": {"displayText": "Api Work Zakybot💻","url": `${myweb}`}},{"quickReplyButton": {"displayText": "💳Bot Masih Gratis💳","id": 'donate'}},{"quickReplyButton": {"displayText": "🗿Yang Kepo Siapa Zaky🗿","id": 'owner'}},{"quickReplyButton": {"displayText": "👉Click Sini Yah👈","id": 'command'}}] )
							}
						if(typemenu == 'templateTenor'){
							alpha.send5ButGif(from, lang.menunya(salam, pushname, botname) , `© ${ownername}` ,pp_bot, [{"urlButton": {"displayText": "YouTube Zaky👨‍💻"","url": `${youtube}`}},{"urlButton": {"displayText": "Api Work Zakybot💻","url": `${myweb}`}},{"quickReplyButton": {"displayText": "💳Bot Masih Gratis💳","id": 'donate'}},{"quickReplyButton": {"displayText": "🗿Yang Kepo Siapa Zaky🗿","id": 'owner'}},{"quickReplyButton": {"displayText": "👉Click Sini Yah👈","id": 'command'}}] , {quoted: m})
						 }
						if(typemenu == 'katalog'){
	...
	case 'infocmd': case'infomenu':{
		alpha.sendButImage(m.chat, sender, [{buttonId: '.command',buttonText:{displayText: '༺ 😪Command Click Sini Yah😪༻'},type: 1},{buttonId:'owner',buttonText: {displayText:'༺😭Nomor Zaky😭༻'}, type: 1}], `Selamat ${salam} @${sender.split('@')[0]} 😭\n\n❏═┅═━–〈「 _*👥Date User👥*_ 」⬣\n┊  *💌Name💌* : ${pushname}\n┊  *📞Number📞* : ${sender.split("@")[0]}\n┊  *📓Status📓* : ${isCreator? ` Owner ${botname}` :`User ${botname}`}\n┗––––––––––✦\n\n❏═┅═━–〈「 _*INFO BOT*_ 」⬣\n┊ *🗿Prefix🗿* :  ${prefix} \n┊ *🗣️Name🗣️* : ${botname}\n┊ *🎭Owner Ganteng🗿* : ${ownername}\n┊ *🌐Mode🌐* : ${alpha.public ? 'Public-Mode' : 'Self-Mode'}\n┊ *👨‍💻Runtime👨‍💻* : ${runtime(process.uptime())}\n┊ *💡Lib💡* : Baileys-Md@4.0.0\n┗––––––––––✦\n\n❏═┅═━–〈「 _*⏲️Server Time⏲️*_ 」⬣\n┊ *⫹⫺Wib* : ${time}\n┊ *⫹⫺Wita* : ${wita}\n┊ *⫹⫺Wit* : ${wit}  \n┗––––––––––✦`, `© ${ownername}`, [sender, ownernomer + '@s.whatsapp.net'], {quoted:m})
      }
  break 
  ...
  break 
	case 'ownercmd': case'ownermenu':{
		alpha.sendButImage(m.chat, sender, [{buttonId: '.command',buttonText:{displayText: '༺ 😪Command Click Sini Yah😪༻'},type: 1},{buttonId:'owner',buttonText: {displayText:'༺😭Nomor Zaky😭༻'}, type: 1}], `Selamat ${salam} @${sender.split('@')[0]} ☹️\n\n❏═┅═━–〈「 _*👥Date User👥*_ 」⬣\n┊  *💌Name💌* : ${pushname}\n┊  *📞Number📞* : ${sender.split("@")[0]}\n┊  *📓Status📓* : ${isCreator? ` Owner ${botname}` :`User ${botname}`}\n┗––––––––––✦\n\n❏═┅═━–〈「 _*INFO BOT*_ 」⬣\n┊ *🗿Prefix🗿* :  ${prefix} \n┊ *🗣️Name🗣️* : ${botname}\n┊ *🎭Owner Ganteng🗿* : ${ownername}\n┊ *🌐Mode🌐* : ${alpha.public ? 'Public-Mode' : 'Self-Mode'}\n┊ *👨‍💻Runtime👨‍💻* : ${runtime(process.uptime())}\n┊ *💡Lib💡* : Baileys-Md@4.0.0\n┗––––––––––✦\n\n❏═┅═━–〈「 _*⏲️Server Time⏲️*_ 」⬣\n┊ *⫹⫺Wib* : ${time}\n┊ *⫹⫺Wita* : ${wita}\n┊ *⫹⫺Wit* : ${wit}  \n┗––––––––––✦`, `© ${ownername}`, [sender, ownernomer + '@s.whatsapp.net'], {quoted:m})
      }
  break 
